...
export function WorkCard({ work }: { work: PublicWork }) {
  ...
  return <article className="portfolio-card"><Link className="portfolio-card-art" href={`/portfolio/${work.slug}`} tabIndex={-1} aria-hidden="true"><img src={workPreviewUrl(work)} alt="" width={1200} height={960} loading="lazy"/><span className="portfolio-card-arrow"><ArrowUpRight size={17}/></span></Link>
