...
export default function Studio({initialDesign}:{initialDesign?:Design}){
 ...
 return <TooltipProvider delayDuration={250}><div className={"atelier design-workspace "+(immersive?"immersive":"")}>
   <header className="app-header">
     <Link href="/" className="brand" onClick={navigate} aria-label="Back to Bead Atelier home"><span className="brand-mark"><Gem size={25} strokeWidth={1.25}/></span><span><b>Bead Atelier<span className="brand-dot">.</span></b><small>THE DESIGN STUDIO</small></span></Link>
