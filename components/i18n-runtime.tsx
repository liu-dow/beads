...
const en: Record<string,string> = {
  "海岸回响":"Coastal Echoes","编辑作品信息":"Edit work details","设计":"Design","游客创":"Guest creator","亮面":"Glossy","颜色":"Colour","质感":"Finish","作品":"Work","Pattern":"Pattern","全景":"Overview","制作":"Making","折叠素材栏":"Collapse materials panel","打开珠子库":"Open bead library","折叠设置栏":"Collapse settings panel","移动图纸":"Move chart","画笔":"Brush","替换同色":"Replace colour","框选图案":"Select area","移动选区":"Move selection","高亮选中色":"Highlight selected colour","复制选区":"Copy selection","粘贴图案":"Paste pattern","选区左右镜像":"Mirror selection horizontally","选区上下镜像":"Mirror selection vertically","重复铺排":"Repeat tile","取消选区":"Clear selection","缩小":"Zoom out","放大":"Zoom in","重置视角":"Reset view","自动旋转":"Auto rotate","图纸色号":"Chart symbols","打开完整二维图纸":"Open full 2D chart","预览环境":"Preview lighting","柔光棚":"Softbox","暖日光":"Warm daylight","侧光":"Side light","背景":"Background","雾白背景":"Mist white","暖砂背景":"Warm sand","深岩背景":"Deep stone","Pattern全景":"Pattern overview","长度":"Length","宽度":"Width","目标手围 / mm":"Target wrist / mm","扣件 / mm":"Clasp / mm","松量 / mm":"Ease / mm","目标珠片长度":"Target bead length","当前含扣件":"Current incl. clasp","预览建议":"Preview suggestion","备珠余量 / %":"Reserve / %","总珠数":"Total beads","色号":"Code","用量":"Qty","备齐":"With reserve","库存":"Stock","需购":"To buy","备齐含":"Reserve includes","余量。":"allowance.","需购数量已扣除库存。":"Purchase qty. excludes stock.","导出制作图纸":"Export making chart","材料清单":"Material list","米珠编织手环":"beaded bracelet","米珠":"beads","创作统计":"Creation stats","统计":"Stats","操作已完成。":"Done.","操作未完成。":"Action could not be completed.","重试连接":"Retry connection","退出登录":"Sign out","账户":"Account","作者姓名":"Author name","导出":"Export","图纸":"Chart","标题":"Title",
